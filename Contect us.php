...
<head>
    ...
    <link rel="stylesheet" href="contect us/css/styles.css">
    <title>Contect Us</title>

</head>
<body>
    <ul class="ul">
    <img src="contect us/image/FAMULAR__3_-removebg-preview.png" alt="" class="logo">
    ...
    <section class="header">
        ...
        <img src="contect us/image/Giant-Audio-Visual-Media-Graphic-1080x810.png" alt="" class="h1">
    </section>
    ...
    <section class="rightbox">
        ...
        <div class="h2">
            <h2 class="heading2">// REACH OUT TO US</h2>
    ...
    <section class="lowerform">
        ...
        <div class="formhead">
            <div class="about">
                <img src="contect us/image/FAMULAR__3_-removebg-preview.png" alt="" class="logo2">
            ...
            <div class="contact">
                ...
                <div class="address">
                    <img src="contect us/image/g1/address (1).png" alt="" class="ad1">
                    <p class="ad2">
                ...
                <div class="email">
                    <img src="contect us/image/g1/email.png" alt="" class="ad1">
                    <p class="ad2">hello@famular.com</p>
                </div>

                <div class="phone">
                    <img src="contect us/image/g1/phone.png" alt="" class="ad1">
